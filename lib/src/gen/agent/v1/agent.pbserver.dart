...
abstract class AdminServiceBase extends $pb.GeneratedService {
  $async.Future<$1.ListTenantsResponse> listTenants(
      $pb.ServerContext ctx, $1.ListTenantsRequest request);
  $async.Future<$1.CreateTenantResponse> createTenant(
      $pb.ServerContext ctx, $1.CreateTenantRequest request);
  $async.Future<$1.UpdateTenantResponse> updateTenant(
      $pb.ServerContext ctx, $1.UpdateTenantRequest request);
  $async.Future<$1.DeleteTenantResponse> deleteTenant(
      $pb.ServerContext ctx, $1.DeleteTenantRequest request);
  $async.Future<$1.IssueTenantTokenResponse> issueTenantToken(
      $pb.ServerContext ctx, $1.IssueTenantTokenRequest request);
  $async.Future<$1.ListTenantTokensResponse> listTenantTokens(
      $pb.ServerContext ctx, $1.ListTenantTokensRequest request);
  $async.Future<$1.RevokeTenantTokenResponse> revokeTenantToken(
      $pb.ServerContext ctx, $1.RevokeTenantTokenRequest request);
  $async.Future<$1.RotateTenantTokenResponse> rotateTenantToken(
      $pb.ServerContext ctx, $1.RotateTenantTokenRequest request);

  $pb.GeneratedMessage createRequest($core.String methodName) {
    switch (methodName) {
      case 'ListTenants':
        return $1.ListTenantsRequest();
      case 'CreateTenant':
        return $1.CreateTenantRequest();
      case 'UpdateTenant':
        return $1.UpdateTenantRequest();
      case 'DeleteTenant':
        return $1.DeleteTenantRequest();
      case 'IssueTenantToken':
        return $1.IssueTenantTokenRequest();
      case 'ListTenantTokens':
        return $1.ListTenantTokensRequest();
      case 'RevokeTenantToken':
        return $1.RevokeTenantTokenRequest();
      case 'RotateTenantToken':
        return $1.RotateTenantTokenRequest();
      default:
        throw $core.ArgumentError('Unknown method: $methodName');
    }
  }
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (methodName) {
      case 'ListTenants':
        return listTenants(ctx, request as $1.ListTenantsRequest);
      case 'CreateTenant':
        return createTenant(ctx, request as $1.CreateTenantRequest);
      case 'UpdateTenant':
        return updateTenant(ctx, request as $1.UpdateTenantRequest);
      case 'DeleteTenant':
        return deleteTenant(ctx, request as $1.DeleteTenantRequest);
      case 'IssueTenantToken':
        return issueTenantToken(ctx, request as $1.IssueTenantTokenRequest);
      case 'ListTenantTokens':
        return listTenantTokens(ctx, request as $1.ListTenantTokensRequest);
      case 'RevokeTenantToken':
        return revokeTenantToken(ctx, request as $1.RevokeTenantTokenRequest);
      case 'RotateTenantToken':
        return rotateTenantToken(ctx, request as $1.RotateTenantTokenRequest);
      default:
        throw $core.ArgumentError('Unknown method: $methodName');
    }
  }
